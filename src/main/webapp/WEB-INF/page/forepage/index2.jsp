                        ...
                        <div class="row">
                            <div class="col-lg-7 col-xl-6 col-md-7 text-center">
                                <div class="slider-content">
                                    ...
                                    <a href="foreDetailUI?id=6" class="slider-btn">查看详情</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-7 col-xl-6 col-md-7 text-center">
                                <div class="slider-content">
                                    ...
                                    <a href="foreDetailUI?id=8" class="slider-btn">查看详情</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="slider-banner-sidebar-three-container">
                        ...
                        <!--=======  banner  =======-->
                        <div class="slider-banner home-four-banner slider-border banner-bg banner-bg-${vs.index+4}">
                                    ...
                                    <div class="image">
                                        <a href="foreDetailUI?id=${product.id}">
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <img  src="../../${product.imageurl}" class="img-fluid ces" alt=""  style="width: 224px;height: 179px;">
                                                    <img  src="../../${product.imageurl}" class="img-fluid ces" alt=""  style="width: 224px;height: 179px;">
                                                </c:otherwise>
                                            </c:choose>
                                        </a>
            ...
            <div class="col-lg-12">
                ...
                <div class="brand-logo-slider-container">
                    ...
                    <div class="single-brand">
                        <a href="#">
                            <img src="${pageContext.request.contextPath}/assets/images/brands/01.jpg" class="img-fluid image" alt="">
                        </a>
                    </div>
                    ...
                    <div class="single-brand">
                        <a href="#">
                            <img src="${pageContext.request.contextPath}/assets/images/brands/02.jpg" class="img-fluid image" alt="">
                        </a>
                    </div>
                    ...
                    <div class="single-brand">
                        <a href="#">
                            <img src="${pageContext.request.contextPath}/assets/images/brands/03.jpg" class="img-fluid image" alt="">
                        </a>
                    </div>
                    ...
                    <div class="single-brand">
                        <a href="#">
                            <img src="${pageContext.request.contextPath}/assets/images/brands/04.jpg" class="img-fluid image" alt="">
                        </a>
                    </div>
                    ...
                    <div class="single-brand">
                        <a href="#">
                            <img src="${pageContext.request.contextPath}/assets/images/brands/05.jpg" class="img-fluid image" alt="">
                        </a>
                    </div>
                    ...
                    <div class="single-brand">
                        <a href="#">
                            <img src="${pageContext.request.contextPath}/assets/images/brands/06.jpg" class="img-fluid image" alt="">
                        </a>
                    </div>
                    ...
                    <div class="single-brand">
                        <a href="#">
                            <img src="${pageContext.request.contextPath}/assets/images/brands/07.jpg" class="img-fluid image" alt="">
                        </a>
                    </div>
                    <div class="single-brand">
                        <a href="#">
