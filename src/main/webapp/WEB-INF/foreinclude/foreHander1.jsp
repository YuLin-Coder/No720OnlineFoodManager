            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="header-top-text text-center text-lg-left mb-0 mb-md-15 mb-sm-15">
                        <p><i class="icon ion-md-alarm"></i> 下单后，15分钟内送达,投诉电话  <span class="support-no">: 0345 154 123 456</span></p>
                    </div>
                </div>
                <div class="col-12 col-lg-6">
                    ...
                    <div class="main-menu">
                        <nav>
                            <ul>
                                ...
                                <li><a href="/fore/information">校园资讯</a></li>
                ...
                <div class="col-12 col-lg-3">
                    ...
                    <div class="navigation-search d-none d-lg-block">
                        <form method="post" action="/fore/foreNameLike">
                            <input type="search" placeholder="搜索商品" name="pName" id="" value="${name}">
